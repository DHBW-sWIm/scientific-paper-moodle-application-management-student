...
class Pool implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['process_ref'] = isset($data['process_ref']) ? $data['process_ref'] : null;
    ...
    {
        return $this->container['process_ref'];
    }

    /**
     * Sets process_ref
     *
     * @param string $process_ref process_ref
     *
     * @return $this
     */
    public function setProcessRef($process_ref)
    {
        $this->container['process_ref'] = $process_ref;
