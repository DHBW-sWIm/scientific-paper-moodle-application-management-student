...
class Operation implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'in_message_ref' => 'string',
        'out_message_ref' => 'string',
        'error_message_ref' => 'string[]'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'in_message_ref' => null,
        'out_message_ref' => null,
        'error_message_ref' => null
    ];
    ...
    protected static $setters = [
        ...
        'name' => 'setName',
        'implementation_ref' => 'setImplementationRef',
        'in_message_ref' => 'setInMessageRef',
        'out_message_ref' => 'setOutMessageRef',
        'error_message_ref' => 'setErrorMessageRef'
    ];
    ...
    protected static $getters = [
        ...
        'name' => 'getName',
        'implementation_ref' => 'getImplementationRef',
        'in_message_ref' => 'getInMessageRef',
        'out_message_ref' => 'getOutMessageRef',
        'error_message_ref' => 'getErrorMessageRef'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['implementation_ref'] = isset($data['implementation_ref']) ? $data['implementation_ref'] : null;
        $this->container['in_message_ref'] = isset($data['in_message_ref']) ? $data['in_message_ref'] : null;
        $this->container['out_message_ref'] = isset($data['out_message_ref']) ? $data['out_message_ref'] : null;
        $this->container['error_message_ref'] = isset($data['error_message_ref']) ? $data['error_message_ref'] : null;
    }
    ...
    /**
     * Gets implementation_ref
     *
     * @return string
     */
    public function getImplementationRef()
    {
        return $this->container['implementation_ref'];
    }

    /**
     * Sets implementation_ref
     *
     * @param string $implementation_ref implementation_ref
     *
     * @return $this
     */
    public function setImplementationRef($implementation_ref)
    {
        $this->container['implementation_ref'] = $implementation_ref;
    ...
    {
        return $this->container['in_message_ref'];
    }

    /**
     * Sets in_message_ref
     *
     * @param string $in_message_ref in_message_ref
     *
     * @return $this
     */
    public function setInMessageRef($in_message_ref)
    {
        $this->container['in_message_ref'] = $in_message_ref;

        return $this;
    }

    /**
     * Gets out_message_ref
     *
     * @return string
     */
    public function getOutMessageRef()
    {
        return $this->container['out_message_ref'];
    }

    /**
     * Sets out_message_ref
     *
     * @param string $out_message_ref out_message_ref
     *
     * @return $this
     */
    public function setOutMessageRef($out_message_ref)
    {
        $this->container['out_message_ref'] = $out_message_ref;

        return $this;
    }

    /**
     * Gets error_message_ref
     *
     * @return string[]
     */
    public function getErrorMessageRef()
    {
        return $this->container['error_message_ref'];
    }

    /**
     * Sets error_message_ref
     *
     * @param string[] $error_message_ref error_message_ref
     *
     * @return $this
     */
    public function setErrorMessageRef($error_message_ref)
    {
        $this->container['error_message_ref'] = $error_message_ref;
