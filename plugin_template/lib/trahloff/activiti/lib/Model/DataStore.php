...
class DataStore implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataStore';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['data_state'] = isset($data['data_state']) ? $data['data_state'] : null;
    ...
    {
        return $this->container['data_state'];
    }

    /**
     * Sets data_state
     *
     * @param string $data_state data_state
     *
     * @return $this
     */
    public function setDataState($data_state)
    {
        $this->container['data_state'] = $data_state;

        return $this;
    }

    /**
     * Gets item_subject_ref
     *
     * @return string
     */
    public function getItemSubjectRef()
    {
        return $this->container['item_subject_ref'];
    }

    /**
     * Sets item_subject_ref
     *
     * @param string $item_subject_ref item_subject_ref
     *
     * @return $this
     */
    public function setItemSubjectRef($item_subject_ref)
    {
        $this->container['item_subject_ref'] = $item_subject_ref;
